...
if($_POST) {
    ...
    $stmt = $conn->prepare("UPDATE packages SET package_name=?, description=?, original_price=?, discounted_price=?, image=? WHERE id=?");
    $stmt->bind_param("ssddsi", $package_name, $description, $original_price, $discounted_price, $image, $package_id);
...
<head>
    ...
    <title>Edit Package - QUICKLAB</title>
                ...
                <div class="form-card">
                    <form method="POST" enctype="multipart/form-data">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="package_name" class="form-control" value="<?php echo $package['package_name']; ?>" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <small class="text-muted">Current: <?php echo $package['image']; ?></small>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="description" class="form-control" rows="3"><?php echo $package['description']; ?></textarea>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" name="original_price" class="form-control" value="<?php echo $package['original_price']; ?>" step="0.01" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label class="form-label">Discounted Price (₹)</label>
                                    <input type="number" name="discounted_price" class="form-control" value="<?php echo $package['discounted_price']; ?>" step="0.01" required>
                                </div>
                            </div>
                        </div>

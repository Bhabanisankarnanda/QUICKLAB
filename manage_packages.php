...
<head>
    ...
    <title>Manage Packages - QUICKLAB</title>
                        ...
                        <table class="table table-hover mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="fw-bold"><?php echo $package['package_name']; ?></td>
                                    <td>
                                        <?php 
                                    ...
                                    <td>₹<?php echo $package['original_price']; ?></td>
                                    <td>₹<?php echo $package['discounted_price']; ?></td>
                                    <td>
                                        <a href="edit_package.php?id=<?php echo $package['id']; ?>" class="btn btn-warning btn-sm btn-action">
                                            <i class="fas fa-edit"></i> Edit
                                        </a>
                                        <a href="manage_packages.php?delete_id=<?php echo $package['id']; ?>" 
